                ...
                <section className="relative pt-24 pb-12 lg:pt-48 lg:pb-32 z-10">
                    <div className="container mx-auto px-6 text-center">
                        ...
                        <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-elite-dark tracking-tight mb-6 lg:mb-8 leading-[1.1]">
                            El Compañero de Aprendizaje <br className="hidden sm:block" />
                            <span className="bg-clip-text text-transparent bg-gradient-cyan block sm:inline mt-2 sm:mt-0">más Inteligente del Mundo</span>
                        </h1>

                        <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto mb-8 sm:mb-10 leading-relaxed font-medium px-2">
                            Tutoría personalizada impulsada por IA, inmersión bilingüe total y el mapa al éxito escolar garantizado. <strong>Bienvenidos a la app del siglo 21.</strong>
                        </p>

          ...
          <div className="space-y-6 mb-10">
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-stone-500 leading-relaxed">
                  Entiendo que Nova Schola utiliza tecnología "Anti-Cheat" (Detección de pestañas, presencia). Acepto recibir reportes diarios vía Email sobre el rendimiento académico y las faltas disciplinarias de mi acudido.
                </p>
              </div>
            </div>
          </div>

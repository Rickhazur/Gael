...
import { Calculator, FlaskConical, BookOpen, Languages, Palette, Sparkles } from 'lucide-react';
...
const SubjectsGrid: React.FC<SubjectsGridProps> = ({ onSelectSubject }) => {
    ...
    const subjects = useMemo(() => [
        ...
        },
        {
            title: 'Spark GPT',
            description: isEn
                ? 'Chat with Spark, your energetic AI guide! Explore famous people and mysteries.'
                : '¡Chatea con Spark, tu guía IA! Explora personajes famosos y misterios del mundo.',
            icon: Sparkles,
            topics: isEn
                ? ['Famous People', 'Curiosity', 'Mind Blowing', 'Mysteries']
                : ['Personajes Famosos', 'Curiosidad', 'Misterios', 'Laboratorio'],
            level: (isEn ? 'Explorer' : 'Explorador') as any,
            type: 'science' as SubjectType,
            viewState: ViewState.SPARK_CHAT
        },
    ], [isEn]);

...
import { ClipboardPaste, Trash2, Sparkles, Loader2, Search } from 'lucide-react';
...
export function TextPasteArea({ value, onChange, onAnalyze, language, grade, onGradeChange, disabled, searchContext }: TextPasteAreaProps) {
    ...
    <div className="glass-panel p-6 space-y-4">
      ...
      <div className="relative">
        <textarea
          ...
          placeholder={language === 'es'
            ? `Pega aquí el texto que encontraste sobre ${searchContext ? searchContext.toUpperCase() : 'Historia, Geografía o Ciencias'}...`
            : `Paste here text you found about ${searchContext ? searchContext.toUpperCase() : 'History, Geography or Sciences'}...`
          }
          className={cn(
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <Button
          ...
          className="relative gap-2 bg-gradient-hero hover:opacity-90 text-primary-foreground shadow-glow-orange overflow-hidden h-12 px-6"
        >
          <motion.span
            animate={{ x: [-2, 2, -2] }}
          ...
          {hasText && (
            <motion.div
              className="absolute -right-1 -top-1 text-2xl pointer-events-none"

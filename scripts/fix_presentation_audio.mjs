...
async function generate(text, filename) {
    ...
    console.log(`🎙️ Generating HIGH QUALITY audio for: ${filename}...`);
...
async function main() {
    console.log("🚀 STARTING DEMO AUDIO GENERATION (NEW KEY)...");
